...
> As with the rest of the project, contributions to 321Vegan are governed by our [Code of Conduct](https://github.com/ISAsxm/321vegan-www/blob/main/CODE_OF_CONDUCT.md).
...
> - Welcome newcomers and encourage new contributors from all walks of life. Visit the [321Vegan Community Code of Conduct](https://github.com/ISAsxm/321vegan-www/blob/main/CODE_OF_CONDUCT.md).
...
1. [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/fork-a-repo) the project, clone your fork, and configure the remotes:
   ...
   git remote add upstream https://github.com/ISAsxm/321vegan-www.git
   ```
...
1. Clone the repository and create a branch
   ...
   ```bash
   git clone https://github.com/ISAsxm/321vegan-www.git
   cd <repo-name>
   git checkout -b <topic-branch-name>
   ```
...
Before you start contributing code, you’ll want to get the project running locally on your machine. Here’s how to set up the `321Vegan www` nextjs app:
...
> 💡 If you're new to React, check out the official [React Getting Started Guide](https://react.dev/)
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/<your-username>/321vegan-www.git
   cd 321vegan-www
   ```
...
3. **Build docker development image**
...
4. **You're up and running! 🎉**
   ...
   Go to [http://localhost:3000/](http://localhost:3000/) and start coding!
...
The main project team can be found in the [Team](https://github.com/ISAsxm/321vegan-www/blob/main/TEAM.md).
...
All persons interacting in the 321Vegan project code bases, issue trackers, discussions and mailing lists are requested to follow the [321Vegan Community Code of Conduct](https://github.com/ISAsxm/321vegan-www/blob/main/CODE_OF_CONDUCT.md).
